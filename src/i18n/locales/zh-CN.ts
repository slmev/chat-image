export default {
  ...
  clearChatFailed: '清空对话失败',
  startNewChatFailed: '新建对话失败',
  clear: '清空',
  confirm: '确认',
  unsavedChanges: '未保存的更改',
  unsavedChangesConfirm: '有未保存的更改，确定不保存就关闭吗？',
  discardChanges: '放弃更改',
  discardChangesConfirm: '有未保存的更改，确定不保存就关闭吗？',
  discard: '放弃',
  ...
  persistenceFailed: '无法将更改保存到本地，请检查存储空间后重试',
  cancelGenerationFailed: '取消生成失败',
  deleteMessageFailed: '删除消息失败',
  workspaceHistory: '历史和画廊',
  parameterInspector: '参数面板',
  noGenerationParameters: '生成后会显示最近一次请求参数',
  messagesUnit: '条消息',
  ...
  replaceAttachment: '替换参考图',
  referenceCount: '{count} 张参考图',
  imagesUnit: '张',
  ...
  deleteHistory: '删除对话',
  deleteHistoryConfirm: '确定要删除这条对话吗？此操作不可恢复。',
  deleteHistoryFailed: '删除对话失败',
  favoriteFailed: '收藏操作失败',
  renameHistoryFailed: '重命名失败',
  ...
  reuseSameParameters: '用同参数再生成',
  reuseParametersConfirm: '当前已输入内容，复用这组参数会覆盖现有输入和参考图。确定继续吗？',
  viewParameters: '查看参数',
  ...
  galleryAspectRatio: '尺寸比例',
  galleryAnyRatio: '全部比例',
  galleryQuality: '质量',
  galleryAnyQuality: '全部质量',
  galleryStyle: '风格',
  galleryAnyStyle: '全部风格',
  galleryReferences: '参考图',
  galleryAnyReferences: '全部参考图',
  galleryWithReferences: '有参考图',
  galleryWithoutReferences: '无参考图',
  galleryDensity: '布局密度',
  galleryDensityComfortable: '舒适布局',
  galleryDensityCompact: '紧凑布局',
  gallerySortLabel: '排序方式',
  gallerySortNewest: '最新优先',
  gallerySortOldest: '最早优先',
  gallerySortFavorite: '收藏优先',
  gallerySelect: '选择',
  gallerySelectAll: '全选',
  galleryDeselectAll: '取消全选',
  gallerySelectedCount: '已选 {count} 张',
  galleryImagesDeleted: '已删除 {count} 张图片',
  galleryDeleteConfirmTitle: '删除图片',
  galleryDeleteConfirmMessage: '确定要删除选中的 {count} 张图片吗？此操作无法撤销。',
  ...
  zipTooLarge: 'ZIP 包超过大小限制（最多 250MB）',
  historyJsonTooLarge: 'history.json 超过大小限制（最多 10MB）',
  tooManyHistories: '历史记录数量超过限制（最多 500 条）',
  tooManyImages: '图片数量超过限制（最多 1000 张）',
  zipImageTooLarge: '图片文件超过大小限制（最多 25MB）：{path}',
  zipImagesTooLarge: '图片文件总大小超过限制（最多 1GB）',
